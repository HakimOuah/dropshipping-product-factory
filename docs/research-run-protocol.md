...
8. Verifier Google Search, Shopping, Trends France et Semrush France via Kloow si autorise.
...
| Kloow/Semrush | tente/utilise si Hakim a confirme l'acces |
...
- si l'outil bloque, documenter le blocage dans `research-run.md`, `google-demand.md` et le rapport final.
...
Contraintes obligatoires : creer/remplir la feuille Google Sheet, utiliser Kloow/Semrush France si l'acces est disponible, chercher 20 a 50 idees brutes, scorer 5 produits minimum sauf justification documentee, tenter AliExpress en serie pour chaque produit score, puis t'arreter a Gate 0.
Pour ce compte, considere que Kloow/Semrush est disponible sauf blocage reel constate : tu dois donc le tenter et documenter le resultat.
```
